...
import com.github.scto.goldenide.BuildConfig
import com.github.scto.goldenide.R
import com.github.scto.goldenide.extension.copyToClipboard
import com.github.scto.goldenide.fragment.InstallResourcesFragment
import com.github.scto.goldenide.common.Analytics
import com.github.scto.goldenide.common.Prefs
import com.github.scto.goldenide.rewrite.util.FileUtil
import com.github.scto.goldenide.util.CommonUtils.isShizukuGranted
    ...
    override fun provideSettings(builder: PreferenceScreen.Builder) {
        builder.apply {
            ...
            expandText("about") {
                ...
                text =
                    "Golden IDE is a free and open-source IDE for Android. It is licensed under the GNU General Public License v3.0."
            }
            singleChoice(
                "donate",
                        ...
                        when (selection) {
                            ...
                            "patreon" -> {
                                activity.startActivity(
                                    Intent(
                                        Intent.ACTION_VIEW,
                                        "https://www.patreon.com/goldenide".toUri()
                                    )
                                )
                            }
                        }
            ...
            pref("manage_storage_permission") {
                ...
                onClick {
                    ...
                    Toast.makeText(
                        activity,
                        "Please enable the manage storage permission for Golden IDE",
                        Toast.LENGTH_LONG
                    ).show()
                    true
                }
